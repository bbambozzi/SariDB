...
public record PersistanceHandler(Path path) {
    ...
    public void writeToFile(Map<String, String> map) throws IOException {
        ...
        try (ParquetWriter<Void> writer = getParquetWriter()) {
    ...
    private ParquetWriter<Void> getParquetWriter() throws IOException {
        ...
        return AvroParquetWriter.<Void>builder(outputFile)
                .withConf(CONF)
                .withSchema(SCHEMA) //
